...
with col2:
    st.write("**Teammate 2**")
    st.write("Image Focus")
    st.image("https://cdn-icons-png.flaticon.com/512/3135/3135715.png", width=150)
    st.markdown("""
    - Image preprocessing
    - Data augmentation techniques
    - Vanilla CNN research
    - EfficientNet model implementation
    """, unsafe_allow_html=True)

with col3:
    st.write("**Teammate 3**")
    st.write("Pipeline & Transfer Learning")
    st.image("https://cdn-icons-png.flaticon.com/512/3135/3135715.png", width=150)
    st.write("""
    - Pipeline implementation
    - Transfer Learning Development
    - Cloud computing setup (AWS Sagemaker)
    """, unsafe_allow_html=True)

with col4:
    st.write("**Teammate 4**")
    st.write("Research & Reporting")
    st.image("https://cdn-icons-png.flaticon.com/512/3135/3135715.png", width=150)
    st.write("""
    - Class balancing
...
st.write("**Mentor**")
st.image("https://cdn-icons-png.flaticon.com/512/3135/3135715.png", width=150)
st.write("Project & team guidance + advisory on DS best practices.")